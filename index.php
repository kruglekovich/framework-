<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/i-03/0427/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . "/i-03/0427/" . $nameSpace . DIRECTORY_SEPARATOR . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/i-03/0427/project/config/routes.php';
